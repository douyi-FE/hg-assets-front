<template>
  <div class="template-container">
    <DynamicTable row-key="id" header-title="Excel模板管理" title-tooltip="Excel模板的管理"
      :data-request="Api.template.getExcelTemplateList" :columns="columns" bordered size="small">
      ...
      <template #toolbar>
        <a-button type="primary" :disabled="!$auth('system:role:create')" @click="openMenuModal({}, 'add')">
          新增
        </a-button>
      </template>
    </DynamicTable>
